   docker compose -f e:\Office\mini_web_projects\helpdesk-develop\helpdesk-develop\docker\docker-compose.yml logs frappe --tail=10 -f

docker compose -f docker/docker-compose.yml ps
>>
>> # View initialization progress
>> docker compose -f docker/docker-compose.yml logs frappe -f
